...
module.exports = grammar({
  ...
  precedences: $ => [
    ["seq"],
    ["assign"],
    ["or", "and", "bitor", "bitxor", "bitand", "compare", "rel", "add", "mul", "unary", "call", "member"]
  ],
  supertypes: $ => [
  ],
  extras: $ => [
